...
<<<<<<< HEAD
=======
      toast.error("please login",{toastId:"login",theme:"colored"})
...
=======
    ...
    <header className='w-full lg:static top-0 left-0 bg-white font-sans'>
      ...
      {/* Navbar-1 */}
      <div className="h-21 bg-green-300 lg:bg-[#dcfff9] flex items-center justify-between w-full px-3 py-1">
        <div className="container mx-auto flex items-center justify-between">

          {/* Menu Icon */}
          <span onClick={toggle} className="inline lg:hidden">
            <i className="ri-menu-line text-3xl"></i>
          </span>
          ...
          <div>
            <button onClick={handleClick}>
                <i className="ri-user-line cursor-pointer text-3xl text-green-600"></i></button>
          </div>
        </div>
      </div>
      ...
      {/* Navbar-2 */}
      <div className={`
        fixed lg:static top-0 left-0 h-screen lg:h-auto w-[60%] lg:w-full
        bg-[#dcfff9] lg:bg-green-600
        transform ${bar ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0
        transition duration-300 z-50
      `}>
        ...
        <div className='container mx-auto px-4 flex flex-col lg:flex-row justify-between items-start lg:items-center'>
          ...
          {/* Menu */}
          <ul className='flex flex-col lg:flex-row gap-6 lg:gap-14 py-6 text-black lg:text-white'>
            ...
            <li>
              <Link to={'/products'} onClick={() => setBar(false)}>Shop</Link>
            </li>

            {/* Dropdown */}
            <li
              ref={dropdownRef}
              className='relative flex flex-col lg:flex-row items-start lg:items-center cursor-pointer'

              // 👉 Hover only for laptop
              onMouseEnter={() => window.innerWidth >= 1024 && setDropdown(true)}
              onMouseLeave={() => window.innerWidth >= 1024 && setDropdown(false)}
            >
            ...
            <Link to={'/wishlist'}>
              <div className="relative cursor-pointer">
                ...
                <span className="text-2xl">
                  ...
                  <i className="ri-poker-hearts-line cursor-pointer"></i>
                </span>
